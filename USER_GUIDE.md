# Plex Play 3.19.11 사용 설명서

Plex Play는 개인 Plex Media Server의 콘텐츠를 Android 휴대폰, 태블릿·폴더블,
Android TV·OTT 기기에서 탐색하고 재생하는 앱입니다. 이 문서는 3.19.11 버전을
기준으로 작성되었습니다.
...
- 내장 자막과 외부 자막이 함께 있으면 `내장 자막 사용` 또는 `외부 자막 사용`을
  먼저 선택할 수 있으며, 선택하지 않은 종류는 동시에 표시되지 않습니다.
- 종류를 선택한 뒤 아래 목록에서 원하는 언어·세부 자막 트랙을 다시 선택할 수 있습니다.
- 외부 자막을 선택하면 Plex 재생기 기본 자막 화면을 숨기고 남아 있는 자막 큐도
  제거하므로 사용자 설정 자막 하나만 표시됩니다. 내장 자막을 선택하면 앱 직접 표시
  자막이 해제됩니다.
- 자동 자막의 우선 언어는 한국어
- 텍스트 자막 글꼴 즉시 적용
