# Plex Play 3.19.24 사용 설명서

Plex Play는 개인 Plex Media Server의 콘텐츠를 Android 휴대폰, 태블릿·폴더블,
Android TV·OTT 기기에서 탐색하고 재생하는 앱입니다. 이 문서는 3.19.24 버전을
기준으로 작성되었습니다.
...
- 텍스트형 Plex 자막은 앱에서 직접 표시하며 사용자 글꼴·크기·색상·외곽선·위치
  설정을 사용할 수 있습니다.
- 품질 변환 중 사용자 설정 자막을 선택하면 재생기의 일반 자막 트랙을 동시에 끄므로
  같은 자막이 두 번 표시되지 않습니다.
- 사용자 자막 파일을 읽지 못한 경우에만 재생기 자막으로 안전하게 전환하며, 자막 끔
  상태는 품질을 변경해도 유지됩니다.
- 자동 자막의 우선 언어는 한국어
- 텍스트 자막 글꼴 즉시 적용
