# Plex Play 3.19.10 사용 설명서

Plex Play는 개인 Plex Media Server의 콘텐츠를 Android 휴대폰, 태블릿·폴더블,
Android TV·OTT 기기에서 탐색하고 재생하는 앱입니다. 이 문서는 3.19.10 버전을
기준으로 작성되었습니다.
...
- 앱 직접 표시 외부 자막을 선택하면 Plex 재생기 자막을 완전히 끄므로 두 자막이
  겹쳐 나오지 않습니다. 내장 자막을 선택하면 앱 직접 표시 자막이 해제됩니다.
- 자동 자막의 우선 언어는 한국어
- 텍스트 자막 글꼴 즉시 적용
